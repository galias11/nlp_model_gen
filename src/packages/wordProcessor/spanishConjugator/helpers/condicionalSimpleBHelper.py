...
def condicional_simple_B_conj(verb, force_conj, mode, irregular_verbs):
    ...
    if not verb in irregular_verbs.keys() or force_conj:
        ...
        return irregular_verbs[verb]['condB']
    for i in range(0, 6):
        ...
        # base.
        if fnmatch.fnmatch(verb, '*uir') and not verb in irregularVerbData['irregular_verbs_grupo_06_ir']:
            base_form += 'y'


        # Elimina la i del sufijo para los verbos del grupo 04, 05 y los
        # terminados en 'uir'.
        if verb in irregularVerbData['irregular_verbs_grupo_04_ducir'] or verb in irregularVerbData['irregular_verbs_grupo_05_er'] or verb in irregularVerbData['irregular_verbs_grupo_05_ñir'] or verb in irregularVerbData['irregular_verbs_grupo_05_ullir'] or verb in irregularVerbData['irregular_verbs_grupo_07_eir'] or verb in irregularVerbData['irregular_verbs_grupo_07_eñir'] or (fnmatch.fnmatch(verb, '*uir') and not verb in irregularVerbData['irregular_verbs_grupo_06_ir']) or fnmatch.fnmatch(verb, '*decir'):
