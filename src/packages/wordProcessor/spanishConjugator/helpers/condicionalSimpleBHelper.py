...
def condicional_simple_B_conj(verb, force_conj, mode, configs):
    ...
    for i in range(0, 6):
        ...
        # terminados en 'uir'.
        if verb in irregular_verb_groups['irregular_verbs_grupo_04_ducir'] or verb in irregular_verb_groups['irregular_verbs_grupo_05_er'] or verb in irregular_verb_groups['irregular_verbs_grupo_05_ñir'] or verb in irregular_verb_groups['irregular_verbs_grupo_05_ullir'] or verb in irregular_verb_groups['irregular_verbs_grupo_07_eir'] or verb in irregular_verb_groups['irregular_verbs_grupo_07_eñir'] or (fnmatch.fnmatch(verb, '*uir') and not verb in irregular_verb_groups['irregular_verbs_grupo_06_ir']) or fnmatch.fnmatch(verb, '*decir'):
