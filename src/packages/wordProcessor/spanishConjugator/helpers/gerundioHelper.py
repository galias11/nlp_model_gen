...
def gerundio(verb, force_conj, mode, irregular_verbs):
    ...
    if not verb in irregular_verbs.keys() or force_conj:
        ...
        return irregular_verbs[verb]['ger']
    for suffix in suffix_conj:
        ...
        if verb in irregularVerbData['irregular_verbs_grupo_11_uir'] or verb in irregularVerbData['irregular_verbs_grupo_07_eir'] or verb in irregularVerbData['irregular_verbs_grupo_07_eñir'] or verb in irregularVerbData['irregular_verbs_grupo_05_er'] or verb in irregularVerbData['irregular_verbs_grupo_05_ñir'] or verb in irregularVerbData['irregular_verbs_grupo_05_ullir']:
            suffix = suffix[1:]
