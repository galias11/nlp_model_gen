...
def gerundio(verb, force_conj, mode, configs):
    ...
    for suffix in suffix_conj:
        ...
        if verb in irregular_verb_groups['irregular_verbs_grupo_11_uir'] or verb in irregular_verb_groups['irregular_verbs_grupo_07_eir'] or verb in irregular_verb_groups['irregular_verbs_grupo_07_eñir'] or verb in irregular_verb_groups['irregular_verbs_grupo_05_er'] or verb in irregular_verb_groups['irregular_verbs_grupo_05_ñir'] or verb in irregular_verb_groups['irregular_verbs_grupo_05_ullir']:
            suffix = suffix[1:]
